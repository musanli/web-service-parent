 ...
 * generated in the com.webservice.service.weather2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://inter.sei.service.webservice.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://inter.sei.service.webservice.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.webservice.service.weather2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://inter.sei.service.webservice.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://inter.sei.service.webservice.com/", name = "queryWeather")
